...
const extraFlags       = " --run -d:strip -d:nimDisableCertificateValidation --include:prelude --forceBuild:on --colors:off --threads:off --verbosity:0 --hints:off --warnings:off --lineTrace:off" + preparedFlags
